...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Hidden achievement
		["Freaky on a Friday Night",	"Juega un Viernes... por la Noche.",					true],
		["She Calls Me Daddy Too",		"Pasate la week 1 en Hard sin fallos.",					false],
		["No More Tricks",				"Pasate la week 2 en Hard sin fallos.",					false],
		["Call Me The Hitman",			"Pasate la week 3 en Hard sin fallos.",					false],
		["Lady Killer",					"Pasate la week 4 en Hard sin fallos.",					false],
		["Missless Christmas",			"Pasate la week 5 en Hard sin fallos.",					false],
		["Highscore!!",					"Pasate la week 6 en Hard sin fallos.",					false],
		["You'll Pay For That...",		"Pasate la week 7 en Hard sin fallos.",					true],
		["What a Funkin' Disaster!",	"Completa una cancion con un accuracy menor de 20%.",	false],
		["Perfectionist",				"Completa una cancion con un accuracy de 100%.",		false],
		["Roadkill Enthusiast",			"Mira a los bailarines de la week 4 morir 100 veces.",	false],
		["Oversinging Much...?",		"Manten pulsada una nota por 20 segundos.",				false],
		["Hyperactive",					"Termina una cancion sin hacer la animacion de idle.",	false],
		["Just the Two of Us",			"Termina una cancion pulsando solo 2 teclas.",			false],
		["Toaster Gamer",				"Has intentado jugar en una tostadora?",			    false],
		["Debugger",					"Pasate la cancion de \"Test\" desde el Menu de Debug.",true]
	];
