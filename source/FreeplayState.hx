...
class FreeplayState extends MusicBeatState
{
	...
	static var songsHeads:Array<Dynamic> = [
		...
		['matt'],                           //WiiK 1
		['mattmad'],					    //WiiK 2
		['mattbox', 'mattbox', 'matt', 'matt', 'matt'],//WiiK 3
		['face'],                           //WiiK Fefe
	...
	override function create()
	{
		...
		add(textBG);
		#if PRELOAD_ALL
		var leText:String = "Pulsa ESPACIO para previsualizar esta cancion / Pulsa RESET para reiniciar tu puntuacion y tu accuracy.";
		#else
		var leText:String = "Pulsa RESET para reiniciar tu puntuacion y tu accuracy.";
		#end
	...
	override function update(elapsed:Float)
	{
		...
		scoreText.text = 'MEJOR PUNTUACION: ' + lerpScore + ' (' + Math.floor(lerpRating * 100) + '%)';
		positionHighscore();
